...
function ItemList ({items}) {
  return (
    ...
    <div className="col-xs-10 col-md-8 offset-md-2 col-xs-offset-1 main-content">
          ...
          <div className="hero-wrapper">
            <header className="hero">
              <div className="profile-info">
                ...
                <div className="hero-location">
                  <i className="fa fa-map-marker"></i>Helsinki
                </div>
              </div>
              <div className="hero-avatar">
                <img alt={items.profile.user.name} className="avatar-image" src={items.profile.user.avatar} height="100" width="100"/>
              </div>
            </header>
            ...
            <div data-react-className="UserFollowContainer" data-react-props="{&quot;followerCount&quot;:6,&quot;followingCount&quot;:2,&quot;following&quot;:false,&quot;followed_id&quot;:396,&quot;hideButton&quot;:false,&quot;username&quot;:&quot;mark&quot;,&quot;overlayTrigger&quot;:true}">
                <div data-reactroot="">
                    ...
                    { items.user._id !== items.profile.user._id ? (<div>{items.user.name ? <FollowButton user={`${items.user.following}`} to_follow={`${items.profile.user._id}`} /> : ''}</div>) : null}
                </div>
            </div>
...
export default connect(mapStateToProps, { getUserProfile, clearUserProfile })(Profile);